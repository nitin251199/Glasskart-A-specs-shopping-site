    ...
    AddFinalProducts.formats = [
     ...
     const fetchAllProducts = async()=>{
      ...
      const handleSubmit = async () =>{
          var body = {producid:productId,colorid:colorId,size:size}
...
<Grid item xs={6}>
            ...
            <ReactQuill
            value={description} 
            modules={AddFinalProducts.modules}
            formats={AddFinalProducts.formats}
